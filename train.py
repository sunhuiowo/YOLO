...
if __name__ == '__main__':
    # model = YOLO('yolo11n-seg.yaml')  # 此处以 n 为例，只需写yolo11n-seg.pt即可定位到n模型
    model = YOLO("weights/YOLOv11/yolo11n-seg.pt")  # 加载预训练权重
    #model = YOLO("yolo8n-seg.yaml").load("yolo8n.pt")  # build from YAML and transfer weights
    model.train(data='datasets/architecture/data.yaml',
